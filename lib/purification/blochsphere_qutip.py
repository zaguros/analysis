### this class has been imported/adapted from qutip. allows for plotting of the blochsphere including states etc.
### All qutip dependencies have been stripped off of it
### NK 2016
...
class Bloch():
    ...
    def plot_back(self):
        ...
        self.axes.plot(1.0 * cos(u), 1.0 * sin(u), zs=0, zdir='z',
                       lw=self.frame_width, color=self.frame_color,alpha = 0.4)
        self.axes.plot(1.0 * cos(u), 1.0 * sin(u), zs=0, zdir='x',alpha = 0.4,
                       lw=self.frame_width, color=self.frame_color)
        self.axes.plot(1.0 * cos(u), 1.0 * sin(u), zs=0, zdir='y',alpha = 0.4,
                       lw=self.frame_width, color=self.frame_color)
    ...
    def plot_front(self):
        ...
        self.axes.plot_wireframe(x, y, z, rstride=5, cstride=5,
                                 ...
                                 alpha=self.frame_alpha)
        # equator
        self.axes.plot(1.0 * cos(u), 1.0 * sin(u),alpha = 0.4,
...
def hide_tick_lines_and_labels(axis):
    '''
