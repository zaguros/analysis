...
class NuclearSpinROC(error.SingleQubitROC):
    def __init__(self):
        ...
        self.F_RO_pulse = 1.
        self.u_F_RO_pulse = 0.
        self.F_RO_pulse_twopi = 1.
        self.u_F_RO_pulse_twopi = 0.
    ...
    def _setup(self):
        ...
        self._F1_ssro, self._F_RO_pulse_twopi = \
                sympy.symbols('F1_ssro F_RO_pulse_twopi')
        
        self.F0_formula.formula = self._F0_ssro * self._F_RO_pulse / self._F_init
        self.F1_formula.formula = self._F1_ssro * self._F_RO_pulse_twopi
        ...
        self.F1_formula.values[self._F_RO_pulse_twopi] = self.F_RO_pulse_twopi
        self.F1_formula.uncertainties[self._F_RO_pulse_twopi] = self.u_F_RO_pulse_twopi
