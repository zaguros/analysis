...
data = pd.read_csv(os.path.join(indir,"Zoki_pos7_Q500_it20000_  3.csv"), usecols=[2,4,5])
...
indices = argrelextrema(I_avg_array, np.greater, order=1020) # the number 100 is somewhat arbitrary, but seems to work. 
...
data_mean.plot(x='Wavelength',y='Intensity',title='Transmission cavity with diamond', legend=False, ylim=[0,14000], xticks=range(600,700,10), yticks=range(0,14000,2000))
plt.savefig("test.eps", format="eps")
#plt.plot(peak_WL, peak_I, 'yo') # for assigning the peaks
