...
indir="D:\DATA/20160706\Scope data" #folder where the data is
data = pd.read_csv(os.path.join(indir,"25DBM_6GHZ.csv"), skiprows=16, names = ["none1", "Y","none2","None"],usecols=[1]) #creating a dataframe in pandas and importing the data
...
#1.e3*np.asarray(data['X'])#[3000:] # multiplied by factor 1.e3  to get ms  
