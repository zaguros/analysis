...
if EOM_ON == True:
	...
	p0, fitfunc, fitfunc_str = common.fit_3lorentz(g_a1, g_A1, g_x01, g_gamma1, g_dx, g_A2, g_gamma2, g_A3, g_gamma3)
	...
	print 'The cavity linewidth is:', round(lw,2), 'GHz, with error', round(lw_error,3), 'GHz'
