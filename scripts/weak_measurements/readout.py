...
path=r'D:\machielblok\Desktop\PhD\QTlab\data\output'
title='readout'

data_fid=np.loadtxt(r'D:\machielblok\Desktop\PhD\QTlab\data\20130404\105338_ADwin_SSRO__LT2_ADwin_SSRO_30nW\ADwin_SSRO-000_fid_vs_ROtime.dat')

data_ROcnts=np.loadtxt(r'D:\machielblok\Desktop\PhD\QTlab\data\20130404\105338_ADwin_SSRO__LT2_ADwin_SSRO_30nW\ADwin_SSRO-000_ro_countrate.dat')

fig=plt.figure(figsize=[1,1])
fig.clf()
gcf().subplots_adjust(bottom=0.25,left=0.25,top=0.96,right=0.96)
ax=fig.add_subplot(111)
ax.errorbar(data_fid[0:25,0],data_fid[0:25,1], yerr=data_fid[0:25,2],marker='.',
	mec='RoyalBlue',ecolor='RoyalBlue',mfc='None',elinewidth=0.5,ms=5,
	label=r'P(>0 photons)',linestyle='None')
ax.errorbar(data_ROcnts[0:25,0]/1000.,data_ROcnts[0:25,1]/(data_ROcnts[0:25,1].max()+0.), marker='.',
	mec='Crimson',ecolor='Crimson',mfc='None',elinewidth=0.5,ms=5,
	label=r'P(ms=0)',linestyle='None')
ax.legend(loc=1, prop={'size':5})
ax.set_yticks([0,.5,1])
ax.set_yticklabels([0,0.5,1],fontsize=fs)
ax.set_ylim([0,1.25])
xticks=[0,10,20]
ax.set_xticks(xticks)
ax.set_xticklabels(xticks,fontsize=fs)
ax.set_xlim([0,20])
ax.set_xlabel(r'RO duration ($\mu$s)',fontsize=fs)
