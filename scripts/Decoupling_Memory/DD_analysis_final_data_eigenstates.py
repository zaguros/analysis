...
new_tsmp = '20170313_015800' ## newer than
old_tsmp = '20170313_213600' ## older than

search_string = 'DecouplingSequence_111_1_sil18_RepT_ShutterNO_XY8sweep_tau_N_1024'
while toolbox.latest_data(contains=search_string,
                                        return_timestamp =True,
                                        older_than=old_tsmp,
                                        newer_than=new_tsmp,
...
new_tsmp = '20170313_015800' ## newer than
old_tsmp = '20170313_163600' ## older than

search_string = 'DecouplingSequence_111_1_sil18_RepT_ShutterNO_XY8sweep_tau_N_512'
while toolbox.latest_data(contains=search_string,
                                        return_timestamp =True,
                                        older_than=old_tsmp,
                                        newer_than=new_tsmp,
...
timestamp_list_8_256=[timestamp41, timestamp40, timestamp39,timestamp38,timestamp37,timestamp36,timestamp33,timestamp30]
...
labels = ['8','16','32','64','128','256','512','1024','2048','3072','6144','10240']
N = [8,16,32,64,128,256,512,1024,2048,3072,6144,10240]
