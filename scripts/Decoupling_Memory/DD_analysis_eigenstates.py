...
#####################################################
new_tsmp = '20161222_221500' ## newer than
old_tsmp = '20161222_225558' ## older than
...
#########################################################
new_tsmp = '20161222_225500' ## newer than
old_tsmp = '20161222_233700' ## older than
search_string = '_DecouplingSequence_111_1_sil18_RepT'
while toolbox.latest_data(contains=search_string,
                                        return_timestamp =True,
                                        older_than=old_tsmp,
...
timestamp_list=[timestamp128,timestamp256,timestamp512]#,timestamp1024]
labels = ['256_1','256_2','256_3','512','1024','2048']
N = [256,256,256,512,1024,2048]
