...
new_tsmp = '20150517_164010' ## newer than
old_tsmp = '20150517_164214' ## older than
search_string = '_DecouplingSequence_111_1_sil18_Single_Block_ShutterNO_XY8_sweep_tau_N_24'
...
while toolbox.latest_data(contains=search_string,
    ...
    old_tsmp, folder = toolbox.latest_data(contains=search_string,
                                        ...
                                        raise_exc=False)
    print old_tsmp
    timestamp24threeblocks.append(old_tsmp)
...
timestamplist = [timestamp24threeblocks,timestamp2048NoShutter,timestamp2048Block,tst2048comparison]
labels = ['repeating T','Block, no shutter','Shutter + Block','rerun repeating T']
timestamplist = [['20150517_170622'],['20150517_170713'],['20150517_170910'],['20150517_170959'],['20150517_171609'],['20150517_171921']]
timestamplist = [['20150517_172943'],['20150517_173747']]
labels = ['Three Blocks','repeatingT','repTdiftau','singleBdifTau']
...
for ii, timestamp in enumerate(timestamplist):
    ...
    # print a.u_p0
    if ii == 0:
        ax = a.plot_results_vs_sweepparam(ret='ax',labels=['Three Blocks'])
