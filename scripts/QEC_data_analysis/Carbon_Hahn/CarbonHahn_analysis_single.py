...
def Carbon_T2_analysis(measurement_name = ['adwindata'], ssro_calib_timestamp ='AUTO', 
            offset = 0.5, 
            amplitude = 0.5,  
            decay_constant = 0.5, 
            x0=0,
            ...
            Addressed_carbon=5,
            el_RO='positive',
            plot_fit = True, do_print = True, show_guess = False, el_state = '1'):
    ...
    if el_state == '1' or el_state == 'both':
        ...
        if Addressed_carbon == 5:
            if el_RO=='positive':
                timestamp=['20150317_084219']# Shutter
                timestamp=['20150317_111643']# No shutter
            else:
                timestamp=['20150317_093928']# Shutter
                timestamp=['20150317_120932']#No shutter
        elif Addressed_carbon == 1:
            if el_RO=='positive':
                timestamp=['20150317_000109']# Shutter
                timestamp=['20150317_023359']#No shutter
            else:   
                timestamp=['20150317_005741']# Shutter
                timestamp=['20150317_032742']#No shutter
        elif Addressed_carbon == 2:
            if el_RO=='positive':
                timestamp=['20150317_042104']# Shutter
                timestamp=['20150317_065552']#No shutter
            else:
                timestamp=['20150317_051738']# Shutter
                timestamp=['20150317_074908']#No shutter
        else:
            print "Carbon not measured"
